...
echo "LOAD DATA INFILE '/tmp/lineitem.tbl.u$set_num' INTO TABLE tmp_lineitem$set_num FIELDS TERMINATED BY '|' LINES TERMINATED BY '\n';" >> tmp_lineitem$set_num.sql

echo "LOAD DATA INFILE '/tmp/orders.tbl.u$set_num' INTO TABLE tmp_orders$set_num FIELDS TERMINATED BY '|' LINES TERMINATED BY '\n';" >> tmp_orders$set_num.sql

$MYSQL -e "create table tmp_lineitem$set_num (l_orderkey numeric(10), l_partkey numeric(10), l_suppkey numeric(10), l_linenumber numeric(10), l_quantity numeric(12,2), l_extendedprice numeric(12,2), l_discount numeric(12,2), l_tax numeric(12,2), l_returnflag char(1), l_linestatus char(1), l_shipdate date, l_commitdate date, l_receiptdate date, l_shipinstruct char(25), l_shipmode char(10), l_comment varchar(44));"

$MYSQL < tmp_lineitem$set_num.sql

$MYSQL -e "insert into lineitem (select * from tmp_lineitem$set_num);"

$MYSQL -e "create table tmp_orders$set_num (o_orderkey numeric(10), o_custkey numeric(10), o_orderstatus char(1), o_totalprice numeric(12,2), o_orderdate date, o_orderpriority char(15), o_clerk char(15), o_shippriority numeric(10), o_comment varchar(79));"

$MYSQL < tmp_orders$set_num.sql

$MYSQL -e "insert into orders (select * from tmp_orders$set_num);"

# clean up
$MYSQL -e "drop table tmp_lineitem$set_num;"

$MYSQL -e "drop table tmp_orders$set_num;"
